...
mixin _$RegisterForm {
 ...
 String get nickname; String get location;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterForm&&(identical(other.nickname, nickname) || other.nickname == nickname)&&(identical(other.location, location) || other.location == location));
}
...
@override
String toString() {
  return 'RegisterForm(nickname: $nickname, location: $location)';
}
...
/// Create a copy of RegisterForm
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nickname = null,Object? location = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String nickname,  String location)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterForm() when $default != null:
return $default(_that.nickname,_that.location);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String nickname,  String location)  $default,) {final _that = this;
switch (_that) {
case _RegisterForm():
return $default(_that.nickname,_that.location);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String nickname,  String location)?  $default,) {final _that = this;
switch (_that) {
case _RegisterForm() when $default != null:
return $default(_that.nickname,_that.location);case _:
  return null;
...
class _RegisterForm implements RegisterForm {
  const _RegisterForm({this.nickname = '', this.location = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RegisterForm&&(identical(other.nickname, nickname) || other.nickname == nickname)&&(identical(other.location, location) || other.location == location));
}
...
/// Create a copy of RegisterForm
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nickname = null,Object? location = null,}) {
