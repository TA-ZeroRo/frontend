            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildSection(
                    '제1조 (목적)',
                    '제로로(ZeroRo)(이하 \'회사\'라고 함)는 회사가 제공하고자 하는 서비스(이하 \'회사 서비스\')를 이용하는 개인(이하 \'이용자\' 또는 \'개인\')의 정보(이하 \'개인정보\')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 \'정보통신망법\') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 \'본 방침\')을 수립합니다.',
                  ),
                  _buildSection(
                    '제2조 (개인정보 처리의 원칙)',
                  ...
                  _buildSection(
                    '제9조 (사전 동의 등에 따른 개인정보의 제공)',
                    '1. 회사는 개인정보 제3자 제공 금지에도 불구하고, 이용자가 사전에 공개하거나 다음 각 호 사항에 대하여 동의한 경우에는 제3자에게 개인정보를 제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로 개인정보를 제공합니다.\n가. Supabase에게 데이터베이스 및 클라우드 스토리지 호스팅을 위하여 회원가입, 서비스 이용을 위해 수집한 정보을 제공\n나. Google에게 로그인을 위하여 소셜 로그인 인증을 제공\n\n2. 회사는 전항의 제3자 제공관계에 변화가 있거나 제3자 제공관계가 종결될 때도 같은 절차에 의해 이용자에게 고지 및 동의를 구합니다.',
                  ),
                  _buildSection(
                  ...
                  _buildSection(
                    '제18조 (개인정보 정보변경 등)',
                    '1. 이용자는 회사에게 전조의 방법을 통해 개인정보의 오류에 대한 정정을 요청할 수 있습니다.\n\n2. 회사는 전항의 경우에 개인정보의 정정을 완료하기 전까지 개인정보를 이용 또는 제공하지 않으며 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리 결과를 제3자에게 지체 없이 통지하여 정정이 이루어지도록 하겠습니다.',
                  ),
                  _buildSection(
                    '제19조 (이용자의 의무)',
